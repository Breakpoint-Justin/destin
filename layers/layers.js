...
var format_Handhole_6 = new ol.format.GeoJSON();
var features_Handhole_6 = format_Handhole_6.readFeatures(json_Handhole_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Handhole_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Handhole_6.addFeatures(features_Handhole_6);
var lyr_Handhole_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Handhole_6, 
                style: style_Handhole_6,
                interactive: true,
                title: '<img src="styles/legend/Handhole_6.png" /> Handhole'
            });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(false);lyr_FiberBackbone_2.setVisible(false);lyr_Fiber_3.setVisible(false);lyr_Fiber_4.setVisible(false);lyr_Flowerpot_5.setVisible(false);lyr_Handhole_6.setVisible(false);lyr_FiberNode_7.setVisible(false);lyr_PrimarySplitter_8.setVisible(false);lyr_Boundary_9.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OpenStreetMap_1,lyr_FiberBackbone_2,lyr_Fiber_3,lyr_Fiber_4,lyr_Flowerpot_5,lyr_Handhole_6,lyr_FiberNode_7,lyr_PrimarySplitter_8,lyr_Boundary_9];
...
lyr_Handhole_6.set('fieldImages', {'v_layer': '', 'v_layer_id': '', 'v_project': '', 'v_project_': '', 'v_plan': '', 'v_plan_id': '', 'v_created_': '', 'v_last_edi': '', 'v_create_1': '', 'v_parent_n': '', 'v_status': '', 'ID': '', 'Size': '', 'Build': '', 'Zone': '', 'Service Gr': '', 'Service Se': '', 'Service Ar': '', 'Tier Ratin': '', '# of Prima': '', '# of Secon': '', '# of Livin': '', 'Ground Rod': '', '# of Fusio': '', 'Owner': '', 'Equipment': '', 'Slack Loop': '', 'Delete Dup': '', 'Documentat': '', 'mat_total_': '', 'lab_total_': '', 'mat_label': '', 'mat_descri': '', 'mat_link': '', 'mat_part_n': '', 'mat_cost': '', 'mat_cost_m': '', 'mat_manufa': '', 'mat_vendor': '', 'lab_label': '', 'lab_descri': '', 'lab_cost': '', 'lab_fixed_': '', 'lab_cost_m': '', 'vetro_id': '', });
