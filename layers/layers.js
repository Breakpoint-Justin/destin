...
var format_FiberBackbone_1 = new ol.format.GeoJSON();
var features_FiberBackbone_1 = format_FiberBackbone_1.readFeatures(json_FiberBackbone_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_FiberBackbone_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FiberBackbone_1.addFeatures(features_FiberBackbone_1);
var lyr_FiberBackbone_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_FiberBackbone_1, 
                style: style_FiberBackbone_1,
                interactive: true,
                title: '<img src="styles/legend/FiberBackbone_1.png" /> Fiber Backbone'
            });
var format_Fiber_2 = new ol.format.GeoJSON();
var features_Fiber_2 = format_Fiber_2.readFeatures(json_Fiber_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Fiber_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Fiber_2.addFeatures(features_Fiber_2);
var lyr_Fiber_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Fiber_2, 
                style: style_Fiber_2,
                interactive: true,
                title: '<img src="styles/legend/Fiber_2.png" /> Fiber'
            });
...
var format_Flowerpot_4 = new ol.format.GeoJSON();
var features_Flowerpot_4 = format_Flowerpot_4.readFeatures(json_Flowerpot_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Flowerpot_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Flowerpot_4.addFeatures(features_Flowerpot_4);
var lyr_Flowerpot_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Flowerpot_4, 
                style: style_Flowerpot_4,
                interactive: true,
                title: '<img src="styles/legend/Flowerpot_4.png" /> Flowerpot'
            });
var format_Handhole_5 = new ol.format.GeoJSON();
var features_Handhole_5 = format_Handhole_5.readFeatures(json_Handhole_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Handhole_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Handhole_5.addFeatures(features_Handhole_5);
var lyr_Handhole_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Handhole_5, 
                style: style_Handhole_5,
                interactive: true,
                title: '<img src="styles/legend/Handhole_5.png" /> Handhole'
            });
var format_FiberNode_6 = new ol.format.GeoJSON();
var features_FiberNode_6 = format_FiberNode_6.readFeatures(json_FiberNode_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_FiberNode_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FiberNode_6.addFeatures(features_FiberNode_6);
var lyr_FiberNode_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_FiberNode_6, 
                style: style_FiberNode_6,
                interactive: true,
                title: '<img src="styles/legend/FiberNode_6.png" /> Fiber Node'
            });
var format_PrimarySplitter_7 = new ol.format.GeoJSON();
var features_PrimarySplitter_7 = format_PrimarySplitter_7.readFeatures(json_PrimarySplitter_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PrimarySplitter_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PrimarySplitter_7.addFeatures(features_PrimarySplitter_7);
var lyr_PrimarySplitter_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PrimarySplitter_7, 
                style: style_PrimarySplitter_7,
                interactive: true,
                title: '<img src="styles/legend/PrimarySplitter_7.png" /> Primary Splitter'
            });
